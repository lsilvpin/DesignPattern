...
namespace DesignPattern.Core.Interfaces.Services.Base
{
  /// <summary>
  /// Serviço de consultas de registros no banco de dados
  /// </summary>
  /// <typeparam name="Entity">Entidade a ser tratada</typeparam>
  public interface IService<Entity> : IDisposable
  {
    /// <summary>
